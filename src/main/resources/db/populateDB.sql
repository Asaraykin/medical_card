...
VALUES (100000, 'кб-4200120', 'Ivanov Nikolay Semenovich', 'Kazan', '123456789', 'М', 2, '1980-05-30'),
       (100001, 'кб-4200121', 'Petrov', 'Moscow', '987654321', 'М', 4, '1936-05-30'),
       (100002, 'кб-4200122', 'Sidorov', 'Калининград', '88888888', 'М', 1, '1960-05-30'),
       (100005, 'кб-34344', 'Sidorov', 'Владивосток', '88888888', 'М', 1, '1960-05-30'),
       (100006, 'кб-6554343', 'Sidorov', 'Самара', '88888888', 'М', 1, '1960-05-30'),
       (100007, 'кб-78923', 'Sidorov', 'Казань', '88888888', 'М', 1, '1960-05-30'),
       (100008, 'кб-980342', 'Sidorov', 'Пенза', '88888888', 'М', 1, '1960-05-30'),
       (100009, 'фр-3423423', 'Sidorov', 'Суздаль', '88888888', 'М', 1, '1960-05-30'),
       (100010, 'зм-456', 'Sidorov', 'Владимир', '88888888', 'М', 1, '1960-05-30'),
       (100011, 'кв-4245645600122', 'Sidorov', 'Тверь', '88888888', 'М', 1, '1960-05-30'),
       (100012, 'ущ-4200456456122', 'Sidorov', 'Ухта', '88888888', 'М', 1, '1960-05-30'),
       (100013, 'зц-42045640122', 'Sidorov', 'Инта', '88888888', 'М', 1, '1960-05-30');
...
VALUES (0, '2015-05-30 10:00:00', 'аппендицит', 100000),
       ...
       (3,
        '2015-05-30 10:00:00',
        'аппендицит255555 5555555555 55555555555555555555 555555555 555555555555555555 5555555',
        100000),
...
VALUES (0, '2015-05-30 10:00:00', 'болит ухо', 'отит', 'капли в уши, антибиотик', 'отек среднего уха', 100000),
...
VALUES (0, '2017-05-30 10:00:00', 'повышен сахар', 0);
